...
# step1: Train on a small dataset, provide a path to save trained model
# step2: Assert if the file exist at the provided path
# step3: Assert if the file indeed psykit learn model
# step4: optionally checksum or md5 the model path
